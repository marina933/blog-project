...
DATABASES = {
    'default': {
        ...
        'NAME': 'database-1new', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': 'marina1993',
        'HOST': 'database-1new.cbvww97wdf3r.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'techtorial-new' # please enter your s3 bucket name
